...
class BookingDetail extends StatefulWidget {
  ...
  const BookingDetail({Key key, this.booking}) : super(key: key);
  @override
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: widget.booking.featured_image,
                    width: 100,
                    height: 100,
                    fit: BoxFit.cover,
                  ),
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${S.of(context).total}: ${widget.booking.price}\$',
                ...
                Container(
                  ...
                  child: Text(
                    widget.booking.orderStatus?.toLowerCase() == 'processing' &&
              ...
              onTap: () => Navigator.of(context)
                ...
                return ChangeNotifierProvider<BookingPaymentModel>(
                    create: (_) => BookingPaymentModel(
                        user: user, booking: widget.booking),
