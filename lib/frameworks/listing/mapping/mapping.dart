      ...
      case 'mylisting':
        {
          ...
          ProductDataMapping =
              Map<String, dynamic>.from(mylisting.ProductDataMapping);
          CategoryDataMapping =
              Map<String, dynamic>.from(mylisting.CategoryDataMapping);
          kCategoryImages =
      ...
      case 'listpro':
        {
          ...
          ProductDataMapping =
              Map<String, dynamic>.from(listpro.ProductDataMapping);
          CategoryDataMapping =
              Map<String, dynamic>.from(listpro.CategoryDataMapping);
      ...
      default:
        {
          ...
          ProductDataMapping =
              Map<String, dynamic>.from(listeo.ProductDataMapping);
          CategoryDataMapping =
              Map<String, dynamic>.from(listeo.CategoryDataMapping);
