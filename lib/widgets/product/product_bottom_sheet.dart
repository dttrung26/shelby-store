...
//    assert(product != null);
  ...
  Widget _buildThumbnail(
    ...
    return ProductThumbnail(thumbnailSize, opacity,
        _productWithId(_list[index]), _productVariationWithId(_list[index]));
  }
    ...
    return FadeTransition(
      ...
      child: ScaleTransition(
        ...
        child: Container(
          width: 40.0,
          height: 40.0,
          child: Tools.image(url: imageFeature, size: kSize.medium),
